...
Namespace Migrations
    ...
    Public NotInheritable Partial Class MarketConnection2
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(MarketConnection2))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201703191410212_MarketConnection2"
            End Get
        End Property
